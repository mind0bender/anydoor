...
const Navbar: FC = (): JSX.Element => {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-white/60 bg-[#e8fff9]/85 backdrop-blur-md px-4 sm:px-8 py-3">
      <div className="mx-auto flex w-full max-w-350 items-center justify-between gap-6">
        <div className="flex items-center gap-6 sm:gap-10">
          <Link
            href="/"
            className="text-xl sm:text-2xl font-bold tracking-tight text-[#003531]"
          >
            AnyDoor
          </Link>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            className="rounded-full p-2.5 text-[#0b6b5d] hover:bg-white/80 transition"
